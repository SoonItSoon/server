...
CSV_FILE = "/home/sslab-hpc/Cap2020/server/S_Message/AMtestData.csv"
...
def getMsgData():
    ...
    failCnt = 0
    # while received == True:
    # for index in [24410, 24518, 24913, 24999, 25076, 26266, 27294, 27299, 31993, 34430, 35057, 41633, 41661, 44665, 45733, 47479, 48758, 49546, 49695, 49710, 49726, 49871, 49877, 49884, 49885, 49902, 49907, 49908, 49918, 49936, 49938, 49940, 49948, 49952, 49954, 49956, 49960, 49968, 49988, 49989, 49993, 50004, 50005, 50010, 50026, 50027, 50033, 50034, 50037, 50043, 50044, 50058, 50060, 50061, 50066, 50432, 50434, 50437, 50438, 50442, 50443, 50449, 50458, 50469, 53035, 54124, 55781, 55945, 56604, 57448, 57674, 57934, 61972, 62326, 63311, 63625, 63878, 66725, 67578, 67585]:
